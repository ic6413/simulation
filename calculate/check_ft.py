...
for method_i in method_list:
	...
	[f_step_error_array, fi_cal_in_error_step, fi_plus_in_error_step] = check_f_function(dp.f_custom + '.h5', ci.id_i, ci.step1, ci.step2, ci.error_tolerence, method=method_i)
