...
#=======Script========================
LMP_INSCRIPT_sm="/home/hllin/simulation/lammps_process/tools/lmp_input/in.lmpscript_simple_20190114_v11"
LMP_INSCRIPT_kkbench_kokkos="/home/hllin/simulation/lammps_process/tools/lmp_input/kokkos_bench/in.chute_kokkos"
LMP_INSCRIPT_kkbench_kokkos_print1="/home/hllin/simulation/lammps_process/tools/lmp_input/kokkos_bench/in.chute_kokkos_print1atom"
LMP_INSCRIPT_ch="in.chute_print1atom"
LMP_INSCRIPT_lj="in.lj_print1atom"
LMP_INSCRIPT_mycylinder="/home/hllin/simulation/lammps_process/tools/lmp_input/in.lmpscript_cylinder"
...
#mpirun ~/lmp_exe/20190712_mymodule_unstable_openmpi314_granular_kkcuda/lmp -pk kokkos neigh half gpu/direct off -k on g 1 -sf kk -in ~/simulation/lammps_process/tools/lmp_input/in.lmpscript_simple_20190114_v11 #${SLURM_CPUS_PER_TASK}
#mpirun ~/lmp_exe/20190712_mymodule_unstable_openmpi314_granular_kkcuda/lmp -pk kokkos neigh half -k on g 1 -sf kk -in ~/simulation/lammps_process/tools/lmp_input/in.lmpscript_simple_20190114_v11 #${SLURM_CPUS_PER_TASK}
#srun --mpi=pmi2 ~/lmp_exe/20190712_mymodule_unstable_openmpi314_granular_kkcuda/lmp -pk kokkos neigh half gpu/direct off -k on g 1 -sf kk -in ~/simulation/lammps_process/tools/lmp_input/in.lmpscript_simple_20190114_v11 #${SLURM_CPUS_PER_TASK}
#srun --mpi=pmi2 ~/lmp_exe/20190712_mymodule_unstable_openmpi314_granular_kkcuda/lmp -pk kokkos neigh half -k on g 1 -sf kk -in ~/simulation/lammps_process/tools/lmp_input/in.lmpscript_simple_20190114_v11 #${SLURM_CPUS_PER_TASK}
