...
LMP_INSCRIPT_mycylinder="/home/hllin/simulation/tools/lmp_input/in.lmpscript_cylinder"
...
#mpirun ~/lmp_exe/20190712_mymodule_unstable_openmpi314_granular_kkcuda/lmp -pk kokkos neigh half gpu/direct off -k on g 1 -sf kk -in ~/simulation/tools/lmp_input/in.lmpscript_simple_20190114_v11 #${SLURM_CPUS_PER_TASK}
#mpirun ~/lmp_exe/20190712_mymodule_unstable_openmpi314_granular_kkcuda/lmp -pk kokkos neigh half -k on g 1 -sf kk -in ~/simulation/tools/lmp_input/in.lmpscript_simple_20190114_v11 #${SLURM_CPUS_PER_TASK}
#srun --mpi=pmi2 ~/lmp_exe/20190712_mymodule_unstable_openmpi314_granular_kkcuda/lmp -pk kokkos neigh half gpu/direct off -k on g 1 -sf kk -in ~/simulation/tools/lmp_input/in.lmpscript_simple_20190114_v11 #${SLURM_CPUS_PER_TASK}
#srun --mpi=pmi2 ~/lmp_exe/20190712_mymodule_unstable_openmpi314_granular_kkcuda/lmp -pk kokkos neigh half -k on g 1 -sf kk -in ~/simulation/tools/lmp_input/in.lmpscript_simple_20190114_v11 #${SLURM_CPUS_PER_TASK}
