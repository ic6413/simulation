...
def main():
    ...
    # steps
    total_steps = float(log_variable['total_step'])

    wallinputstepsarray = np.arange(5000000,total_steps-1000000,1000000)
    fraction_steps = np.arange(4000000,total_steps-1000000,1000000)
    velocityinputstepsarray = np.arange(5000000,total_steps-1000000,1000000)
    stress_steps = np.arange(3000000,total_steps-1000000,10000000)
    omega_max_steps = np.array([total_steps-1000000])
    mu_I_steps = np.arange(5300000,total_steps-1000000,10000)
