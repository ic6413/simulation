...
class chunk(object):
    ...
    def __init__(self, n_ave, lmp_path, f_path_rela_lmpfolder):
        ...
        if chunk_method == "rz":
            self.chunk_x_array = firstdata(self.n_line_in_a_step, self.lines, "v_r", self.header)
            self.chunk_y_array = firstdata(self.n_line_in_a_step, self.lines, "v_z", self.header)
            self.chunk_x_array_label = "r"
            self.chunk_y_array_label = "z"
        elif chunk_method == "yz":
            self.chunk_x_array = firstdata(self.n_line_in_a_step, self.lines, "Coord1", self.header)
            self.chunk_y_array = firstdata(self.n_line_in_a_step, self.lines, "Coord2", self.header)
...
if __name__ == "__main__":
    ...
    number_average_list = [50]
    for number_average in number_average_list:
